            ...
            <div class="w-full md:w-10/12 lg:w-8/12 mx-auto">
                <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                    <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                        <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl text-center">Sign up</h2>

                        <form class="mt-8">
                            <div class="space-y-5">
                                <div>
                                    <label class="text-base font-medium text-gray-900"> Fast & Last name </label>
                        ...
                        <div className='py-5'>
                            <p class="mt-2 text-base text-gray-600">Already have an account? <Link to='/login' class="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">Login</Link></p>
                        </div>
